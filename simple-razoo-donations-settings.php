...
class razoo_settings_page {
  ...
  function color_input(){
    ...
    echo '<p class="description">';
    printf( __( 'Provide the color you want to use for the donation form using the color picker.  If possible, you should match this to one of your website\'s colors by using a %shexadecimal value%s (#000000).', 'simple-razoo-donations' ),
      '<a href="http://www.w3schools.com/html/html_colors.asp" target="_blank">',
      '</a>'
    );
    echo '</p>';
